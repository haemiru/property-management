        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-100 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md p-8 rounded-3xl shadow-2xl border border-slate-100">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center space-x-3 bg-white border-2 border-slate-200 text-slate-700 font-semibold py-4 px-6 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                >
                    {loading ? (
                ...
                <div className="my-8 flex items-center">
                    ...
                    <span className="px-4 text-xs text-slate-400 font-medium">간편하게 시작하세요</span>
                    <div className="flex-1 border-t border-slate-200"></div>
                </div>
